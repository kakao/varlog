...
// Source: github.daumkakao.com/varlog/varlog/pkg/varlog (interfaces: MetadataRefresher)
...
func (mr *MockMetadataRefresherMockRecorder) Refresh(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
