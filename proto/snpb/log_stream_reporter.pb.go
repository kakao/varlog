...
type LogStreamUncommitReport struct {
	...
	Version               github_daumkakao_com_varlog_varlog_pkg_types.Version     `protobuf:"varint,4,opt,name=version,proto3,casttype=github.daumkakao.com/varlog/varlog/pkg/types.Version" json:"version,omitempty"`
...
func (m *LogStreamUncommitReport) GetVersion() github_daumkakao_com_varlog_varlog_pkg_types.Version {
	if m != nil {
		return m.Version
	}
	return 0
...
type LogStreamCommitResult struct {
	...
	Version             github_daumkakao_com_varlog_varlog_pkg_types.Version     `protobuf:"varint,6,opt,name=version,proto3,casttype=github.daumkakao.com/varlog/varlog/pkg/types.Version" json:"version,omitempty"`
...
func (m *LogStreamCommitResult) GetTopicID() github_daumkakao_com_varlog_varlog_pkg_types.TopicID {
	if m != nil {
		return m.TopicID
	}
	return 0
...
func (m *LogStreamCommitResult) GetVersion() github_daumkakao_com_varlog_varlog_pkg_types.Version {
	if m != nil {
		return m.Version
	}
	return 0
