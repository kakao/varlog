...
func (m *GetPrevCommitResultRequest) GetHighWatermark() github_com_kakao_varlog_pkg_types.GLSN {
	if m != nil {
		return m.HighWatermark
	}
	return 0
...
func (m *GetPrevCommitResultResponse) GetStorageNodeID() github_com_kakao_varlog_pkg_types.StorageNodeID {
	if m != nil {
		return m.StorageNodeID
	}
	return 0
