...
type LocalLogStreamDescriptor struct {
	...
	HighWatermark        github_daumkakao_com_varlog_varlog_pkg_varlog_types.GLSN          `protobuf:"varint,2,opt,name=high_watermark,json=highWatermark,proto3,casttype=github.daumkakao.com/varlog/varlog/pkg/varlog/types.GLSN" json:"high_watermark,omitempty"`
...
func (m *LocalLogStreamDescriptor) GetStorageNodeID() github_daumkakao_com_varlog_varlog_pkg_varlog_types.StorageNodeID {
	if m != nil {
...
func (m *LocalLogStreamDescriptor) GetHighWatermark() github_daumkakao_com_varlog_varlog_pkg_varlog_types.GLSN {
	if m != nil {
...
type LocalLogStreamDescriptor_LogStreamUncommitReport struct {
	...
	UncommittedLLSNOffset github_daumkakao_com_varlog_varlog_pkg_varlog_types.LLSN        `protobuf:"varint,2,opt,name=uncommitted_llsn_offset,json=uncommittedLlsnOffset,proto3,casttype=github.daumkakao.com/varlog/varlog/pkg/varlog/types.LLSN" json:"uncommitted_llsn_offset,omitempty"`
...
func (m *LocalLogStreamDescriptor_LogStreamUncommitReport) GetLogStreamID() github_daumkakao_com_varlog_varlog_pkg_varlog_types.LogStreamID {
	if m != nil {
...
func (m *LocalLogStreamDescriptor_LogStreamUncommitReport) GetUncommittedLLSNOffset() github_daumkakao_com_varlog_varlog_pkg_varlog_types.LLSN {
	if m != nil {
...
type GlobalLogStreamDescriptor struct {
	HighWatermark        github_daumkakao_com_varlog_varlog_pkg_varlog_types.GLSN `protobuf:"varint,1,opt,name=high_watermark,json=highWatermark,proto3,casttype=github.daumkakao.com/varlog/varlog/pkg/varlog/types.GLSN" json:"high_watermark,omitempty"`
	PrevHighWatermark    github_daumkakao_com_varlog_varlog_pkg_varlog_types.GLSN `protobuf:"varint,2,opt,name=prev_high_watermark,json=prevHighWatermark,proto3,casttype=github.daumkakao.com/varlog/varlog/pkg/varlog/types.GLSN" json:"prev_high_watermark,omitempty"`
...
func (m *GlobalLogStreamDescriptor) GetHighWatermark() github_daumkakao_com_varlog_varlog_pkg_varlog_types.GLSN {
	if m != nil {
		return m.HighWatermark
	}
	return 0
...
func (m *GlobalLogStreamDescriptor) GetPrevHighWatermark() github_daumkakao_com_varlog_varlog_pkg_varlog_types.GLSN {
	if m != nil {
...
type GlobalLogStreamDescriptor_LogStreamCommitResult struct {
	LogStreamID          github_daumkakao_com_varlog_varlog_pkg_varlog_types.LogStreamID `protobuf:"varint,1,opt,name=log_stream_id,json=logStreamId,proto3,casttype=github.daumkakao.com/varlog/varlog/pkg/varlog/types.LogStreamID" json:"log_stream_id,omitempty"`
	CommittedGLSNOffset  github_daumkakao_com_varlog_varlog_pkg_varlog_types.GLSN        `protobuf:"varint,2,opt,name=committed_glsn_offset,json=committedGlsnOffset,proto3,casttype=github.daumkakao.com/varlog/varlog/pkg/varlog/types.GLSN" json:"committed_glsn_offset,omitempty"`
...
func (m *GlobalLogStreamDescriptor_LogStreamCommitResult) GetLogStreamID() github_daumkakao_com_varlog_varlog_pkg_varlog_types.LogStreamID {
	if m != nil {
		return m.LogStreamID
	}
	return 0
...
func (m *GlobalLogStreamDescriptor_LogStreamCommitResult) GetCommittedGLSNOffset() github_daumkakao_com_varlog_varlog_pkg_varlog_types.GLSN {
	if m != nil {
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PrevHighWatermark |= github_daumkakao_com_varlog_varlog_pkg_varlog_types.GLSN(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CommittedGLSNOffset |= github_daumkakao_com_varlog_varlog_pkg_varlog_types.GLSN(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
