...
func (m *SealRequest) GetClusterID() github_daumkakao_com_varlog_varlog_pkg_varlog_types.ClusterID {
	if m != nil {
		return m.ClusterID
	}
	return 0
...
type SealResponse struct {
	...
	LastCommittedGLSN    github_daumkakao_com_varlog_varlog_pkg_varlog_types.GLSN `protobuf:"varint,2,opt,name=last_committed_glsn,json=lastCommittedGlsn,proto3,casttype=github.daumkakao.com/varlog/varlog/pkg/varlog/types.GLSN" json:"last_committed_glsn,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                                 `json:"-"`
	XXX_unrecognized     []byte                                                   `json:"-"`
	XXX_sizecache        int32                                                    `json:"-"`
}
...
func (m *SealResponse) GetLastCommittedGLSN() github_daumkakao_com_varlog_varlog_pkg_varlog_types.GLSN {
	if m != nil {
...
func (m *UnsealRequest) GetClusterID() github_daumkakao_com_varlog_varlog_pkg_varlog_types.ClusterID {
	if m != nil {
		return m.ClusterID
	}
	return 0
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LastCommittedGLSN |= github_daumkakao_com_varlog_varlog_pkg_varlog_types.GLSN(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
