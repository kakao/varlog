...
type AddPeerRequest struct {
	...
	NodeID               github_com_kakao_varlog_pkg_varlog_types.NodeID    `protobuf:"varint,2,opt,name=node_id,json=nodeId,proto3,casttype=github.com/kakao/varlog/pkg/varlog/types.NodeID" json:"node_id,omitempty"`
...
func (m *AddPeerRequest) GetClusterID() github_com_kakao_varlog_pkg_varlog_types.ClusterID {
	if m != nil {
		return m.ClusterID
	}
	return 0
...
func (m *AddPeerRequest) GetNodeID() github_com_kakao_varlog_pkg_varlog_types.NodeID {
	if m != nil {
		return m.NodeID
	}
	return 0
...
func (m *RemovePeerRequest) GetClusterID() github_com_kakao_varlog_pkg_varlog_types.ClusterID {
	if m != nil {
		return m.ClusterID
	}
	return 0
...
func (m *RemovePeerRequest) GetNodeID() github_com_kakao_varlog_pkg_varlog_types.NodeID {
	if m != nil {
		return m.NodeID
	}
	return 0
...
func (m *GetClusterInfoRequest) GetClusterID() github_com_kakao_varlog_pkg_varlog_types.ClusterID {
	if m != nil {
		return m.ClusterID
	}
	return 0
...
type ClusterInfo struct {
	ClusterID            github_com_kakao_varlog_pkg_varlog_types.ClusterID                      `protobuf:"varint,1,opt,name=cluster_id,json=clusterId,proto3,casttype=github.com/kakao/varlog/pkg/varlog/types.ClusterID" json:"cluster_id,omitempty"`
	NodeID               github_com_kakao_varlog_pkg_varlog_types.NodeID                         `protobuf:"varint,2,opt,name=node_id,json=nodeId,proto3,casttype=github.com/kakao/varlog/pkg/varlog/types.NodeID" json:"node_id,omitempty"`
	Leader               github_com_kakao_varlog_pkg_varlog_types.NodeID                         `protobuf:"varint,3,opt,name=leader,proto3,casttype=github.com/kakao/varlog/pkg/varlog/types.NodeID" json:"leader,omitempty"`
	...
	Members              map[github_com_kakao_varlog_pkg_varlog_types.NodeID]*ClusterInfo_Member `protobuf:"bytes,5,rep,name=members,proto3,castkey=github.com/kakao/varlog/pkg/varlog/types.NodeID" json:"members,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                                                                           `json:"-"`
	XXX_unrecognized     []byte                                                                             `json:"-"`
	XXX_sizecache        int32                                                                              `json:"-"`
}
...
func (m *ClusterInfo) GetClusterID() github_com_kakao_varlog_pkg_varlog_types.ClusterID {
	if m != nil {
		return m.ClusterID
	}
	return 0
...
func (m *ClusterInfo) GetNodeID() github_com_kakao_varlog_pkg_varlog_types.NodeID {
	if m != nil {
		return m.NodeID
	}
	return 0
...
func (m *ClusterInfo) GetLeader() github_com_kakao_varlog_pkg_varlog_types.NodeID {
	if m != nil {
		return m.Leader
	}
	return 0
...
func (m *ClusterInfo) GetMembers() map[github_com_kakao_varlog_pkg_varlog_types.NodeID]*ClusterInfo_Member {
	if m != nil {
		return m.Members
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[github_com_kakao_varlog_pkg_varlog_types.NodeID]*ClusterInfo_Member)(nil), "varlog.mrpb.ClusterInfo.MembersEntry")
...
func (m *ClusterInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if m.Members == nil {
				m.Members = make(map[github_com_kakao_varlog_pkg_varlog_types.NodeID]*ClusterInfo_Member)
			}
			var mapkey uint64
