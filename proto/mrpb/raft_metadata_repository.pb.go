...
func (m *LogStreamCommitResults) GetVersion() github_daumkakao_com_varlog_varlog_pkg_types.Version {
	if m != nil {
		return m.Version
	}
	return 0
...
type MetadataRepositoryDescriptor_LogStreamDescriptor struct {
	TrimVersion     github_daumkakao_com_varlog_varlog_pkg_types.Version                                   `protobuf:"varint,1,opt,name=trim_version,json=trimVersion,proto3,casttype=github.daumkakao.com/varlog/varlog/pkg/types.Version" json:"trim_version,omitempty"`
...
func (m *MetadataRepositoryDescriptor_LogStreamDescriptor) GetTrimVersion() github_daumkakao_com_varlog_varlog_pkg_types.Version {
	if m != nil {
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TrimVersion |= github_daumkakao_com_varlog_varlog_pkg_types.Version(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
