...
type MetadataRepositoryDescriptor struct {
	...
	Peers                map[github_daumkakao_com_varlog_varlog_pkg_types.NodeID]*MetadataRepositoryDescriptor_PeerDescriptor `protobuf:"bytes,3,rep,name=peers,proto3,castkey=github.daumkakao.com/varlog/varlog/pkg/types.NodeID" json:"peers,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *MetadataRepositoryDescriptor) GetPeers() map[github_daumkakao_com_varlog_varlog_pkg_types.NodeID]*MetadataRepositoryDescriptor_PeerDescriptor {
	if m != nil {
		return m.Peers
	}
	return nil
