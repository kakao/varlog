...
type MetadataRepositoryDescriptor struct {
	...
	Peers                map[github_com_kakao_varlog_pkg_varlog_types.NodeID]string `protobuf:"bytes,3,rep,name=peers,proto3,castkey=github.com/kakao/varlog/pkg/varlog/types.NodeID" json:"peers,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Endpoints            map[github_com_kakao_varlog_pkg_varlog_types.NodeID]string `protobuf:"bytes,4,rep,name=endpoints,proto3,castkey=github.com/kakao/varlog/pkg/varlog/types.NodeID" json:"endpoints,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *MetadataRepositoryDescriptor) GetPeers() map[github_com_kakao_varlog_pkg_varlog_types.NodeID]string {
	if m != nil {
		return m.Peers
	}
	return nil
...
func (m *MetadataRepositoryDescriptor) GetEndpoints() map[github_com_kakao_varlog_pkg_varlog_types.NodeID]string {
	if m != nil {
		return m.Endpoints
	}
	return nil
...
type MetadataRepositoryDescriptor_LocalLogStreamReplica struct {
	UncommittedLLSNOffset github_com_kakao_varlog_pkg_varlog_types.LLSN `protobuf:"varint,1,opt,name=uncommitted_llsn_offset,json=uncommittedLlsnOffset,proto3,casttype=github.com/kakao/varlog/pkg/varlog/types.LLSN" json:"uncommitted_llsn_offset,omitempty"`
	...
	KnownHighWatermark    github_com_kakao_varlog_pkg_varlog_types.GLSN `protobuf:"varint,3,opt,name=known_high_watermark,json=knownHighWatermark,proto3,casttype=github.com/kakao/varlog/pkg/varlog/types.GLSN" json:"known_high_watermark,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}                                                 `json:"-"`
	XXX_unrecognized      []byte                                                   `json:"-"`
	XXX_sizecache         int32                                                    `json:"-"`
}
...
func (m *MetadataRepositoryDescriptor_LocalLogStreamReplica) GetUncommittedLLSNOffset() github_com_kakao_varlog_pkg_varlog_types.LLSN {
	if m != nil {
...
func (m *MetadataRepositoryDescriptor_LocalLogStreamReplica) GetKnownHighWatermark() github_com_kakao_varlog_pkg_varlog_types.GLSN {
	if m != nil {
...
type MetadataRepositoryDescriptor_LocalLogStreamReplicas struct {
	Replicas             map[github_com_kakao_varlog_pkg_varlog_types.StorageNodeID]*MetadataRepositoryDescriptor_LocalLogStreamReplica `protobuf:"bytes,1,rep,name=replicas,proto3,castkey=github.com/kakao/varlog/pkg/varlog/types.StorageNodeID" json:"replicas,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *MetadataRepositoryDescriptor_LocalLogStreamReplicas) GetReplicas() map[github_com_kakao_varlog_pkg_varlog_types.StorageNodeID]*MetadataRepositoryDescriptor_LocalLogStreamReplica {
	if m != nil {
		return m.Replicas
	}
	return nil
...
type MetadataRepositoryDescriptor_LogStreamDescriptor struct {
	TrimGLSN             github_com_kakao_varlog_pkg_varlog_types.GLSN                                                                 `protobuf:"varint,1,opt,name=trim_glsn,json=trimGlsn,proto3,casttype=github.com/kakao/varlog/pkg/varlog/types.GLSN" json:"trim_glsn,omitempty"`
	...
	LocalLogStreams      map[github_com_kakao_varlog_pkg_varlog_types.LogStreamID]*MetadataRepositoryDescriptor_LocalLogStreamReplicas `protobuf:"bytes,3,rep,name=local_log_streams,json=localLogStreams,proto3,castkey=github.com/kakao/varlog/pkg/varlog/types.LogStreamID" json:"local_log_streams,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                                                                                                                 `json:"-"`
	XXX_unrecognized     []byte                                                                                                                   `json:"-"`
	XXX_sizecache        int32                                                                                                                    `json:"-"`
}
...
func (m *MetadataRepositoryDescriptor_LogStreamDescriptor) GetTrimGLSN() github_com_kakao_varlog_pkg_varlog_types.GLSN {
	if m != nil {
		return m.TrimGLSN
	}
	return 0
...
func (m *MetadataRepositoryDescriptor_LogStreamDescriptor) GetLocalLogStreams() map[github_com_kakao_varlog_pkg_varlog_types.LogStreamID]*MetadataRepositoryDescriptor_LocalLogStreamReplicas {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[github_com_kakao_varlog_pkg_varlog_types.NodeID]string)(nil), "varlog.mrpb.MetadataRepositoryDescriptor.EndpointsEntry")
	proto.RegisterMapType((map[github_com_kakao_varlog_pkg_varlog_types.NodeID]string)(nil), "varlog.mrpb.MetadataRepositoryDescriptor.PeersEntry")
	...
	proto.RegisterMapType((map[github_com_kakao_varlog_pkg_varlog_types.StorageNodeID]*MetadataRepositoryDescriptor_LocalLogStreamReplica)(nil), "varlog.mrpb.MetadataRepositoryDescriptor.LocalLogStreamReplicas.ReplicasEntry")
	...
	proto.RegisterMapType((map[github_com_kakao_varlog_pkg_varlog_types.LogStreamID]*MetadataRepositoryDescriptor_LocalLogStreamReplicas)(nil), "varlog.mrpb.MetadataRepositoryDescriptor.LogStreamDescriptor.LocalLogStreamsEntry")
}
...
func (m *MetadataRepositoryDescriptor) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Peers == nil {
				m.Peers = make(map[github_com_kakao_varlog_pkg_varlog_types.NodeID]string)
			}
			var mapkey uint64
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.Peers[github_com_kakao_varlog_pkg_varlog_types.NodeID(mapkey)] = mapvalue
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
			...
			if m.Endpoints == nil {
				m.Endpoints = make(map[github_com_kakao_varlog_pkg_varlog_types.NodeID]string)
			}
			var mapkey uint64
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.Endpoints[github_com_kakao_varlog_pkg_varlog_types.NodeID(mapkey)] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRaftMetadataRepository(dAtA[iNdEx:])
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.KnownHighWatermark |= github_com_kakao_varlog_pkg_varlog_types.GLSN(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *MetadataRepositoryDescriptor_LocalLogStreamReplicas) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Replicas == nil {
				m.Replicas = make(map[github_com_kakao_varlog_pkg_varlog_types.StorageNodeID]*MetadataRepositoryDescriptor_LocalLogStreamReplica)
			}
			var mapkey int32
			...
			m.Replicas[github_com_kakao_varlog_pkg_varlog_types.StorageNodeID(mapkey)] = mapvalue
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TrimGLSN |= github_com_kakao_varlog_pkg_varlog_types.GLSN(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 3:
			...
			if m.LocalLogStreams == nil {
				m.LocalLogStreams = make(map[github_com_kakao_varlog_pkg_varlog_types.LogStreamID]*MetadataRepositoryDescriptor_LocalLogStreamReplicas)
			}
			var mapkey uint64
			...
			m.LocalLogStreams[github_com_kakao_varlog_pkg_varlog_types.LogStreamID(mapkey)] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRaftMetadataRepository(dAtA[iNdEx:])
