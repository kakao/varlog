...
func (m *UnregisterStorageNode) GetStorageNodeID() github_com_kakao_varlog_pkg_varlog_types.StorageNodeID {
	if m != nil {
...
func (m *UnregisterLogStream) GetLogStreamID() github_com_kakao_varlog_pkg_varlog_types.LogStreamID {
	if m != nil {
...
func (m *Seal) GetLogStreamID() github_com_kakao_varlog_pkg_varlog_types.LogStreamID {
	if m != nil {
		return m.LogStreamID
	}
	return 0
...
func (m *Unseal) GetLogStreamID() github_com_kakao_varlog_pkg_varlog_types.LogStreamID {
	if m != nil {
		return m.LogStreamID
	}
	return 0
...
type AddPeer struct {
	NodeID               github_com_kakao_varlog_pkg_varlog_types.NodeID `protobuf:"varint,1,opt,name=node_id,json=nodeId,proto3,casttype=github.com/kakao/varlog/pkg/varlog/types.NodeID" json:"node_id,omitempty"`
...
func (m *AddPeer) GetNodeID() github_com_kakao_varlog_pkg_varlog_types.NodeID {
	if m != nil {
		return m.NodeID
	}
	return 0
...
func (m *RemovePeer) GetNodeID() github_com_kakao_varlog_pkg_varlog_types.NodeID {
	if m != nil {
		return m.NodeID
	}
	return 0
...
func (m *Endpoint) GetNodeID() github_com_kakao_varlog_pkg_varlog_types.NodeID {
	if m != nil {
		return m.NodeID
	}
	return 0
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NodeID |= github_com_kakao_varlog_pkg_varlog_types.NodeID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
