...
func (m *ListStorageNodesResponse) GetStorageNodes() map[github_com_kakao_varlog_pkg_types.StorageNodeID]*snpb.StorageNodeMetadataDescriptor {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[github_com_kakao_varlog_pkg_types.StorageNodeID]*snpb.StorageNodeMetadataDescriptor)(nil), "varlog.vmspb.ListStorageNodesResponse.StorageNodesEntry")
