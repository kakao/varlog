...
type ListStorageNodesResponse struct {
	...
	StorageNodes map[github_daumkakao_com_varlog_varlog_pkg_types.StorageNodeID]*StorageNodeMetadata `protobuf:"bytes,1,rep,name=storage_nodes,json=storageNodes,proto3,castkey=github.daumkakao.com/varlog/varlog/pkg/types.StorageNodeID" json:"storageNodes" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *ListStorageNodesResponse) GetStorageNodes() map[github_daumkakao_com_varlog_varlog_pkg_types.StorageNodeID]*StorageNodeMetadata {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[github_daumkakao_com_varlog_varlog_pkg_types.StorageNodeID]*StorageNodeMetadata)(nil), "varlog.vmspb.ListStorageNodesResponse.StorageNodesEntry")
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.StorageNodes == nil {
				m.StorageNodes = make(map[github_daumkakao_com_varlog_varlog_pkg_types.StorageNodeID]*StorageNodeMetadata)
			}
			var mapkey int32
