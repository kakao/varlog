...
func (m *UnregisterStorageNodeRequest) GetStorageNodeID() github_com_kakao_varlog_pkg_varlog_types.StorageNodeID {
	if m != nil {
...
type UnregisterLogStreamRequest struct {
	LogStreamID          github_com_kakao_varlog_pkg_varlog_types.LogStreamID `protobuf:"varint,1,opt,name=log_stream_id,json=logStreamId,proto3,casttype=github.com/kakao/varlog/pkg/varlog/types.LogStreamID" json:"log_stream_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                                        `json:"-"`
	XXX_unrecognized     []byte                                                          `json:"-"`
	XXX_sizecache        int32                                                           `json:"-"`
}
...
func (m *UnregisterLogStreamRequest) GetLogStreamID() github_com_kakao_varlog_pkg_varlog_types.LogStreamID {
	if m != nil {
...
func (m *RemoveLogStreamReplicaRequest) GetStorageNodeID() github_com_kakao_varlog_pkg_varlog_types.StorageNodeID {
	if m != nil {
		return m.StorageNodeID
	}
	return 0
...
func (m *RemoveLogStreamReplicaRequest) GetLogStreamID() github_com_kakao_varlog_pkg_varlog_types.LogStreamID {
	if m != nil {
		return m.LogStreamID
	}
	return 0
...
type UpdateLogStreamRequest struct {
	...
	//(gogoproto.casttype) =
	//"github.com/kakao/varlog/pkg/varlog/types.StorageNodeID",
...
func (m *UpdateLogStreamRequest) GetLogStreamID() github_com_kakao_varlog_pkg_varlog_types.LogStreamID {
	if m != nil {
		return m.LogStreamID
	}
	return 0
...
type SyncRequest struct {
	LogStreamID          github_com_kakao_varlog_pkg_varlog_types.LogStreamID   `protobuf:"varint,1,opt,name=log_stream_id,json=logStreamId,proto3,casttype=github.com/kakao/varlog/pkg/varlog/types.LogStreamID" json:"log_stream_id,omitempty"`
	SrcStorageNodeID     github_com_kakao_varlog_pkg_varlog_types.StorageNodeID `protobuf:"varint,2,opt,name=src_storage_node_id,json=srcStorageNodeId,proto3,casttype=github.com/kakao/varlog/pkg/varlog/types.StorageNodeID" json:"src_storage_node_id,omitempty"`
	DstStorageNodeID     github_com_kakao_varlog_pkg_varlog_types.StorageNodeID `protobuf:"varint,3,opt,name=dst_storage_node_id,json=dstStorageNodeId,proto3,casttype=github.com/kakao/varlog/pkg/varlog/types.StorageNodeID" json:"dst_storage_node_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                                          `json:"-"`
	XXX_unrecognized     []byte                                                            `json:"-"`
	XXX_sizecache        int32                                                             `json:"-"`
}
...
func (m *SyncRequest) GetSrcStorageNodeID() github_com_kakao_varlog_pkg_varlog_types.StorageNodeID {
	if m != nil {
...
func (m *SyncRequest) GetDstStorageNodeID() github_com_kakao_varlog_pkg_varlog_types.StorageNodeID {
	if m != nil {
...
type GetMRMembersResponse struct {
	Leader               github_com_kakao_varlog_pkg_varlog_types.NodeID            `protobuf:"varint,1,opt,name=leader,proto3,casttype=github.com/kakao/varlog/pkg/varlog/types.NodeID" json:"leader,omitempty"`
	...
	Members              map[github_com_kakao_varlog_pkg_varlog_types.NodeID]string `protobuf:"bytes,3,rep,name=members,proto3,castkey=github.com/kakao/varlog/pkg/varlog/types.NodeID" json:"members,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                                                              `json:"-"`
	XXX_unrecognized     []byte                                                                `json:"-"`
	XXX_sizecache        int32                                                                 `json:"-"`
}
...
func (m *GetMRMembersResponse) GetLeader() github_com_kakao_varlog_pkg_varlog_types.NodeID {
	if m != nil {
		return m.Leader
	}
	return 0
...
func (m *GetMRMembersResponse) GetMembers() map[github_com_kakao_varlog_pkg_varlog_types.NodeID]string {
	if m != nil {
		return m.Members
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[github_com_kakao_varlog_pkg_varlog_types.NodeID]string)(nil), "varlog.vmspb.GetMRMembersResponse.MembersEntry")
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SrcStorageNodeID |= github_com_kakao_varlog_pkg_varlog_types.StorageNodeID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DstStorageNodeID |= github_com_kakao_varlog_pkg_varlog_types.StorageNodeID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Leader |= github_com_kakao_varlog_pkg_varlog_types.NodeID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 3:
			...
			if m.Members == nil {
				m.Members = make(map[github_com_kakao_varlog_pkg_varlog_types.NodeID]string)
			}
			var mapkey uint64
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.Members[github_com_kakao_varlog_pkg_varlog_types.NodeID(mapkey)] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipVms(dAtA[iNdEx:])
