...
type GetStorageNodesResponse struct {
	StorageNodes map[github_com_kakao_varlog_pkg_types.StorageNodeID]*snpb.StorageNodeMetadataDescriptor `protobuf:"bytes,1,rep,name=storage_nodes,json=storageNodes,proto3,castkey=github.com/kakao/varlog/pkg/types.StorageNodeID" json:"storageNodes" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *GetStorageNodesResponse) GetStorageNodes() map[github_com_kakao_varlog_pkg_types.StorageNodeID]*snpb.StorageNodeMetadataDescriptor {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[github_com_kakao_varlog_pkg_types.StorageNodeID]*snpb.StorageNodeMetadataDescriptor)(nil), "varlog.vmspb.GetStorageNodesResponse.StorageNodesEntry")
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.StorageNodes == nil {
				m.StorageNodes = make(map[github_com_kakao_varlog_pkg_types.StorageNodeID]*snpb.StorageNodeMetadataDescriptor)
			}
			var mapkey int32
