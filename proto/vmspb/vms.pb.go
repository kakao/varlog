...
type SealResponse struct {
	LogStreams []varlogpb.LogStreamMetadataDescriptor            `protobuf:"bytes,1,rep,name=log_streams,json=logStreams,proto3" json:"logStreams"`
...
type GetStorageNodesResponse struct {
	StorageNodes map[github_com_kakao_varlog_pkg_types.StorageNodeID]string `protobuf:"bytes,1,rep,name=storage_nodes,json=storageNodes,proto3,castkey=github.com/kakao/varlog/pkg/types.StorageNodeID" json:"storageNodes" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *GetStorageNodesResponse) GetStorageNodes() map[github_com_kakao_varlog_pkg_types.StorageNodeID]string {
	if m != nil {
...
type TrimResult struct {
	LogStreamID github_com_kakao_varlog_pkg_types.LogStreamID `protobuf:"varint,1,opt,name=log_stream_id,json=logStreamId,proto3,casttype=github.com/kakao/varlog/pkg/types.LogStreamID" json:"logStreamId"`
...
func init() {
	...
	proto.RegisterMapType((map[github_com_kakao_varlog_pkg_types.StorageNodeID]string)(nil), "varlog.vmspb.GetStorageNodesResponse.StorageNodesEntry")
...
var fileDescriptor_682aff4a3f93d15c = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.StorageNodes == nil {
				m.StorageNodes = make(map[github_com_kakao_varlog_pkg_types.StorageNodeID]string)
			}
			var mapkey int32
			var mapvalue string
			for iNdEx < postIndex {
