...
type SyncRequest struct {
	LogStreamID          github_com_kakao_varlog_pkg_types.LogStreamID   `protobuf:"varint,1,opt,name=log_stream_id,json=logStreamId,proto3,casttype=github.com/kakao/varlog/pkg/types.LogStreamID" json:"log_stream_id,omitempty"`
	SrcStorageNodeID     github_com_kakao_varlog_pkg_types.StorageNodeID `protobuf:"varint,2,opt,name=src_storage_node_id,json=srcStorageNodeId,proto3,casttype=github.com/kakao/varlog/pkg/types.StorageNodeID" json:"src_storage_node_id,omitempty"`
	DstStorageNodeID     github_com_kakao_varlog_pkg_types.StorageNodeID `protobuf:"varint,3,opt,name=dst_storage_node_id,json=dstStorageNodeId,proto3,casttype=github.com/kakao/varlog/pkg/types.StorageNodeID" json:"dst_storage_node_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                                   `json:"-"`
	XXX_unrecognized     []byte                                                     `json:"-"`
	XXX_sizecache        int32                                                      `json:"-"`
}
...
type GetStorageNodesResponse struct {
	Storagenodes         map[github_com_kakao_varlog_pkg_types.StorageNodeID]string `protobuf:"bytes,1,rep,name=storagenodes,proto3,castkey=github.com/kakao/varlog/pkg/types.StorageNodeID" json:"storagenodes,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                                                              `json:"-"`
	XXX_unrecognized     []byte                                                                `json:"-"`
	XXX_sizecache        int32                                                                 `json:"-"`
}
...
var fileDescriptor_682aff4a3f93d15c = []byte{
	...
	,
}
