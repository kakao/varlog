...
//go:generate mockgen -build_flags -mod=vendor -self_package github.daumkakao.com/varlog/varlog/internal/varlogadm/stats -package stats -destination repository_mock.go . Repository
