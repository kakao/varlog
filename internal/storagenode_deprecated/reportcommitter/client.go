...
//go:generate mockgen -build_flags -mod=vendor -self_package github.com/kakao/varlog/internal/storagenode_deprecated/reportcommitter -package reportcommitter -destination client_mock.go . Client
