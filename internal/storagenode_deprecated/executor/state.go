...
//go:generate mockgen -self_package github.daumkakao.com/varlog/varlog/internal/storagenode_deprecated/executor -package executor -source state.go -destination state_mock.go -mock_names stateProvider=MockStateProvider
