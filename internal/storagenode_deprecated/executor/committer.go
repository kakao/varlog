...
//go:generate mockgen -self_package github.com/kakao/varlog/internal/storagenode_deprecated/executor -package executor -source committer.go -destination committer_mock.go -mock_names committer=MockCommitter
