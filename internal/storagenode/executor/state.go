...
//go:generate mockgen -self_package github.com/kakao/varlog/internal/storagenode/executor -package executor -source state.go -destination state_mock.go -mock_names stateProvider=MockStateProvider
