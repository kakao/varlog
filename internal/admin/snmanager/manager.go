...
//go:generate mockgen -build_flags -mod=vendor -self_package github.daumkakao.com/varlog/varlog/internal/admin/snmanager -package snmanager -destination manager_mock.go . StorageNodeManager
