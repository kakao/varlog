...
//go:generate mockgen -build_flags -mod=vendor -self_package github.daumkakao.com/varlog/varlog/internal/admin -package admin -destination replica_selector_mock.go . ReplicaSelector
